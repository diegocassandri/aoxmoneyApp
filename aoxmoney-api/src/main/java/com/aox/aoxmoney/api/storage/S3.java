package com.aox.aoxmoney.api.storage;
...
public class S3 {
    ...
    public void salvar(String objeto) {
        SetObjectTaggingRequest setObjectTaggingResult = new SetObjectTaggingRequest(
                property.getS3().getBucket(),
                objeto,
                new ObjectTagging(Collections.emptyList()));

        amazonS3.setObjectTagging(setObjectTaggingResult);
